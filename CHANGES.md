...
- Added stdin support to CLI commands, enabling usage in shell pipelines.
- CLI commands can now read input from a string argument, a UTF-8 text file, or standard input.
